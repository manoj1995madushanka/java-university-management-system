...
public class lecProfile extends javax.swing.JFrame {
    ...
    void setFields(CLecturer bld){
        //txtFirstname.setText(s.getFirstName());
        txtlecid.setText(new Integer(bld.getLecid()).toString());
        txtFullName.setText(bld.getFullname());
        txtName.setText(bld.getName());
        txtnic.setText(bld.getNIC());
        txtSubjects.setText(bld.getSubject());
        txtTeachingYear.setText(bld.getTeachingyear());
        txtDegree.setText(bld.getDegree());
        txtUniversity.setText(bld.getUniversity());
        txtExperiance.setText(bld.getExperiance());
        txtPhone.setText(bld.getPhone());
        txtEmail.setText(bld.getEmail());
        txtAddress.setText(bld.getAddress());
    }
    ...
    private void initComponents() {
        ...
        txtTeachingYear.setEditable(false);

        txtDegree.setEditable(false);

        txtUniversity.setEditable(false);

        txtExperiance.setEditable(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtAddress, javax.swing.GroupLayout.DEFAULT_SIZE, 612, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtlecid, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtTeachingYear, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
