...
import Computing.lecturers.*;
import javax.swing.JOptionPane;


public class updateBLecturer extends javax.swing.JFrame {

    CLecDBOperation bldb=new CLecDBOperation();
    
    public updateBLecturer() {
        initComponents();
    }
    
    void setFields(CLecturer bl){
    ...
    private void initComponents() {
        ...
        txtTeachingYear = new javax.swing.JTextField();
        txtDegree = new javax.swing.JTextField();
        txtUniversity = new javax.swing.JTextField();
        txtExperiance = new javax.swing.JTextField();
        ...
        setTitle("Update Lecturer Profile");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtTeachingYear)
                            .addComponent(txtDegree)
                            .addComponent(txtUniversity)
                            .addComponent(txtExperiance)
                            .addComponent(txtPhone)
                            .addComponent(txtEmail)
                            .addComponent(txtAddress, javax.swing.GroupLayout.DEFAULT_SIZE, 608, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtlecid, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(txtTeachingYear, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(txtExperiance, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        bl.setLecid(new Integer(txtlecid.getText()).intValue());
        bl.setFullname(txtFullName.getText());
        bl.setName(txtName.getText());
        bl.setNIC(txtnic.getText());
        bl.setSubject(txtSubjects.getText());
        bl.setTeachingyear(txtTeachingYear.getText());
        bl.setDegree(txtDegree.getText());
        bl.setUniversity(txtUniversity.getText());
        bl.setExperiance(txtExperiance.getText());
        bl.setPhone(txtPhone.getText());
        bl.setEmail(txtEmail.getText());
        bl.setAddress(txtAddress.getText());
        if(bldb.addlecturer(bl)){
            JOptionPane.showMessageDialog(this, "Successfully inserted values!!!");
            //clearfields();
            this.dispose();
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateBLecturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updateBLecturer().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtExperiance;
    private javax.swing.JTextField txtFullName;
    private javax.swing.JTextField txtName;
    private javax.swing.JTextField txtPhone;
    private javax.swing.JTextField txtSubjects;
    private javax.swing.JTextField txtTeachingYear;
