...
public class viewlecturer extends javax.swing.JFrame {
    ...
    ArrayList<CLecturer> CLList1;
    CLecDBOperation bldb=new CLecDBOperation();
    
    void loadLecterer(){
        CLList1=bldb.getlecturer(); //for the first year students
        CLecturerDetails bll=new CLecturerDetails(CLList1);
        //int year = Calendar.getInstance().get(Calendar.YEAR);
        tblyear1lec.setModel(bll);
    ...
    private void initComponents() {
        ...
        tblyear1lec = new javax.swing.JTable();
        ...
        tblyear1lec.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "lecturer ID", "Name", "Degree", "Subject"
            }
        ));
        jScrollPane1.setViewportView(tblyear1lec);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        lecProfile lp=new lecProfile();
        lp.setVisible(true);
        lp.setFields(CLList1.get(tblyear1lec.getSelectedRow()));
        lp.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    }//GEN-LAST:event_btnViewActionPerformed

    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        updateBLecturer ul=new updateBLecturer();
        ul.setVisible(true);
        ul.setFields(CLList1.get(tblyear1lec.getSelectedRow()));
        ul.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        //us.setDefaultCloseOperation(this.dispose());

        ul.addWindowListener(new WindowListener(){
            @Override
            public void windowOpened(WindowEvent e) {
                //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
            }
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        dl.setVisible(true);
        dl.setFields(CLList1.get(tblyear1lec.getSelectedRow()));
    ...
    private javax.swing.JTable tblyear1lec;
