...
public class AddResultOperation {
    ...
    public boolean addResult(Cresult br) {
        try {
            System.out.println("started adding");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofcomputingresults VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    ArrayList <Cresult> getResult(){
        ArrayList <Cresult> bb=new ArrayList<Cresult>();
        try {
            System.out.println("started updating");
            con = (Connection) DriverManager.getConnection(url, username, password);
            
            
            String query ="SELECT * FROM schoolofcomputingresults";
            System.out.println("query created");
            pst=(com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
            rs=pst.executeQuery();
