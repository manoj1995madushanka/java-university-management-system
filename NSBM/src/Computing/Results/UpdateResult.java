...
public class UpdateResult extends javax.swing.JFrame {
    ...
    /*void getResult() {
        try {
            String sql = "SELECT sub1mark,sub2mark,sub3mark,sub4mark,sub5mark,sub6mark,sub7mark FROM schoolofbusinessresults WHERE regid =?";
            pst = conn.prepareStatement(sql);
            pst.setString(1, txtreg1.getText());

            rs = pst.executeQuery();
            while (rs.next()) {
                txtsub1mark.setText(rs.getString("sub1mark"));
                txtsub2mark.setText(rs.getString("sub2mark"));
                txtsub3mark.setText(rs.getString("sub3mark"));
                txtsub4mark.setText(rs.getString("sub4mark"));
                txtsub5mark.setText(rs.getString("sub5mark"));
                txtsub6mark.setText(rs.getString("sub6mark"));
                txtsub7mark.setText(rs.getString("sub7mark"));
