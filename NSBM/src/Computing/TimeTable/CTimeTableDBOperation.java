...
public class CTimeTableDBOperation {
    ...
    public boolean addSubject(timetable tt) {
        try {
            ...
            String query = "INSERT INTO schoolofcomputingtimetable VALUES (?,?,?,?,?,?,?)";
    ...
    ArrayList<timetable> getvaluesyr1sem1mon() {
        try {
            ...
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "SELECT * FROM schoolofcomputingtimetable WHERE year="+year1+" AND sem="+sem1+" AND day='"+day1+"'";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
    ...
    public boolean updateSubject(timetable tt) {
        try {
            ...
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "UPDATE schoolofcomputingtimetable SET subjectname='" + tt.getSubname() + "',location='" + tt.getLocation() + "',time='" + tt.getTime() + "',year=" + tt.getYear() +",sem=" + tt.getSem() + ",day='" + tt.getDay() + "' WHERE subjectid=" + tt.getSubid();
    ...
    public boolean deleteSubject(timetable tt) {
        try {
            ...
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "DELETE FROM schoolofcomputingtimetable WHERE subjectid="+ tt.getSubid();
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
