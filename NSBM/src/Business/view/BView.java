...
//import Business.selectSubjectsYear1.setSem;
import Business.selectsubjects.mainsub;
...
public class BView extends javax.swing.JFrame {
    ...
    ArrayList<BStudent> stList1;
    ArrayList<BStudent> stList2;
    ArrayList<BStudent> stList3;
    ArrayList<BStudent> stList4;//for get year four students in suitable table
    
    BDBoperation dbops=new BDBoperation();
    
    
    void loadStudents(){    //for load the table data from studendetails class
        stList1=dbops.getStudent1(); //for the first year students
        BStudentDetails std1=new BStudentDetails(stList1);
        //int year = Calendar.getInstance().get(Calendar.YEAR);
        tblView1.setModel(std1);
        
        
        stList2=dbops.getStudent2();//for get second year student
        BStudentDetails2 std2=new BStudentDetails2(stList2);
        tblView2.setModel(std2);
        
        stList3=dbops.getStudent3();//for third year students
        BStudentDetails3 std3=new BStudentDetails3(stList3);
        tblView3.setModel(std3);
        
        stList4=dbops.getStudent4();//for fourth year students
        BStudentDetails4 std4=new BStudentDetails4(stList4);
    ...
    private void initComponents() {
        ...
        setTitle("Students of school of business NSBM");
        ...
        jLabel1.setText("School of Business Students");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
