...
public class ETimeTableDBOperation {
    ...
    public boolean addSubject(timetable tt) {
        try {
            ...
            String query = "INSERT INTO schoolofengineeringtimetable VALUES (?,?,?,?,?,?,?)";
            ...
            pst.setString(4, tt.getLocation());
    ...
    ArrayList<timetable> getvaluesyr1sem1mon() {
        try {
            ...
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "SELECT * FROM schoolofengineeringtimetable WHERE year="+year1+" AND sem="+sem1+" AND day='"+day1+"'";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
    ...
    public boolean updateSubject(timetable tt) {
        try {
            ...
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "UPDATE schoolofengineeringtimetable SET subjectname='" + tt.getSubname() + "',location='" + tt.getLocation() + "',time='" + tt.getTime() + "',year=" + tt.getYear() +",sem=" + tt.getSem() + ",day='" + tt.getDay() + "' WHERE subjectid=" + tt.getSubid();
    ...
    public boolean deleteSubject(timetable tt) {
        try {
            ...
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "DELETE FROM schoolofengineeringtimetable WHERE subjectid="+ tt.getSubid();
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
