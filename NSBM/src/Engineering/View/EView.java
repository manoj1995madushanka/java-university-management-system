...
import Engineering.selectsubjects.mainsub;
...
public class EView extends javax.swing.JFrame {
    ...
    ArrayList<EStudent> stList1;
    ArrayList<EStudent> stList2;
    ArrayList<EStudent> stList3;
    ArrayList<EStudent> stList4;//for get year four students in suitable table
    
    EDBOperation dbops=new EDBOperation();
    
    
    void loadStudents(){    //for load the table data from studendetails class
        stList1=dbops.getStudent1(); //for the first year students
        EStudentDetails std1=new EStudentDetails(stList1);
        //int year = Calendar.getInstance().get(Calendar.YEAR);
        tblView1.setModel(std1);
        
        
        stList2=dbops.getStudent2();//for get second year student
        EStudentDetails2 std2=new EStudentDetails2(stList2);
        tblView2.setModel(std2);
        
        stList3=dbops.getStudent3();//for third year students
        EStudentDetails3 std3=new EStudentDetails3(stList3);
        tblView3.setModel(std3);
        
        stList4=dbops.getStudent4();//for fourth year students
        EStudentDetails4 std4=new EStudentDetails4(stList4);
