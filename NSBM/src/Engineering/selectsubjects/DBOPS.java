...
public class DBOPS {
    ...
    public boolean y1s1engineering(Subs s1) {
        try {

            System.out.println("set result 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineeringsem1year1 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public boolean y1s2engineering(Subs s1) {
        try {

            System.out.println("set result 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineeringsem2year1 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
            System.out.println("set result 2");
            //pst.setInt(1, sb.getStudentID());//address,gender,faculty,depar,year
            pst.setInt(1, s1.getStid());
    ...
    public boolean y2s1engineering(Subs s1) {
        try {

            System.out.println("set result 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineeringsem1year2 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
            System.out.println("set result 2");
            //pst.setInt(1, sb.getStudentID());//address,gender,faculty,depar,year
            pst.setInt(1, s1.getStid());
    ...
    public boolean y2s2engineering(Subs s1) {
        try {

            System.out.println("set result 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineeringsem2year2 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
            System.out.println("set result 2");
            //pst.setInt(1, sb.getStudentID());//address,gender,faculty,depar,year
            pst.setInt(1, s1.getStid());
    ...
    public boolean y3s1engineering(Subs s1) {
        try {

            System.out.println("set result 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineeringsem1year3 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
            System.out.println("set result 2");
            //pst.setInt(1, sb.getStudentID());//address,gender,faculty,depar,year
            pst.setInt(1, s1.getStid());
    ...
    public boolean y3s2engineering(Subs s1) {
        try {

            System.out.println("set result 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineeringsem2year3 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
            System.out.println("set result 2");
            //pst.setInt(1, sb.getStudentID());//address,gender,faculty,depar,year
            pst.setInt(1, s1.getStid());
    ...
    public boolean y4s1engineering(Subs s1) {
        try {

            System.out.println("set result 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineeringsem1year4 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
            System.out.println("set result 2");
            //pst.setInt(1, sb.getStudentID());//address,gender,faculty,depar,year
            pst.setInt(1, s1.getStid());
    ...
    public boolean y4s2engineering(Subs s1) {
        try {

            System.out.println("set result 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineeringsem2year4 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            pst = (com.mysql.jdbc.PreparedStatement) con.prepareStatement(query);
            System.out.println("set result 2");
            //pst.setInt(1, sb.getStudentID());//address,gender,faculty,depar,year
            pst.setInt(1, s1.getStid());
