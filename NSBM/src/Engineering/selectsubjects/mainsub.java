...
public class mainsub extends javax.swing.JFrame {
    ...
    final DefaultComboBoxModel y1s1 = new DefaultComboBoxModel(new String[]{"EY1S1Item1", "EY1S1Item2", "EY1S1Item3"});
    final DefaultComboBoxModel y1s2 = new DefaultComboBoxModel(new String[]{"EY1S2Item1", "EY1S2Item2", "EY1S2Item3"});
    final DefaultComboBoxModel y2s1 = new DefaultComboBoxModel(new String[]{"EY2S1Item1", "EY2S1Item2", "EY2S1Item3"});
    final DefaultComboBoxModel y2s2 = new DefaultComboBoxModel(new String[]{"EY2S2Item1", "EY2S2Item2", "EY2S2Item3"});
    final DefaultComboBoxModel y3s1 = new DefaultComboBoxModel(new String[]{"EY3S1Item1", "EY3S1Item2", "EY3S1Item3"});
    final DefaultComboBoxModel y3s2 = new DefaultComboBoxModel(new String[]{"EY3S2Item1", "EY3S2Item2", "EY3S2Item3"});
    final DefaultComboBoxModel y4s1 = new DefaultComboBoxModel(new String[]{"EY4S1Item1", "EY4S1Item2", "EY4S1Item3"});
    final DefaultComboBoxModel y4s2 = new DefaultComboBoxModel(new String[]{"EY4S2Item1", "EY4S2Item2", "EY4S2Item3"});

    void setFields() {
        if ((cbYear.getSelectedItem().toString() == "1 year") && (cbSem.getSelectedItem().toString() == "semester 1")) {
            txtSub1.setText("Engineering 1");
            txtSub1Lec.setText("Dr. Jayantha Silva");
            txtSub1Amount.setText("3000");
            txtSub1Credit.setText("3");

            txtSub2.setText("Engineering 2");
            txtSub2Lec.setText("Dr. Sarath Fonseka");
            txtSub2Amount.setText("3000");
            txtSub2Credit.setText("3");

            txtSub3.setText("Engineering 3");
            ...
            txtSub1.setText("Engineering 4");
            txtSub1Lec.setText("Dr. Jayantha Silva");
            txtSub1Amount.setText("3000");
            txtSub1Credit.setText("3");

            txtSub2.setText("Engineering 5");
            txtSub2Lec.setText("Dr. Sarath Fonseka");
            txtSub2Amount.setText("3000");
            txtSub2Credit.setText("3");

            txtSub3.setText("Engineerint 6");
            txtSub3Lec.setText("Dr. Saman Randunu");
            txtSub3Amount.setText("3000");
            txtSub3Credit.setText("3");
            ...
            txtSub1.setText("Engineering 7");
            txtSub1Lec.setText("Dr. Jayantha Silva");
            txtSub1Amount.setText("3000");
            txtSub1Credit.setText("3");

            txtSub2.setText("Engineering 8");
            txtSub2Lec.setText("Dr. Sarath Fonseka");
            txtSub2Amount.setText("3000");
            txtSub2Credit.setText("3");

            txtSub3.setText("Engineering 9");
            txtSub3Lec.setText("Dr. Saman Randunu");
            txtSub3Amount.setText("3000");
            txtSub3Credit.setText("3");
            ...
            txtSub1.setText("Subject");
            txtSub1Lec.setText("Dr. Jayantha Silva");
            txtSub1Amount.setText("3000");
            txtSub1Credit.setText("3");

            txtSub2.setText("Subject");
            txtSub2Lec.setText("Dr. Sarath Fonseka");
            txtSub2Amount.setText("3000");
            txtSub2Credit.setText("3");

            txtSub3.setText("Subject");
            txtSub3Lec.setText("Dr. Saman Randunu");
            txtSub3Amount.setText("3000");
            txtSub3Credit.setText("3");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Subject selecting and payment form for School of Computing");
