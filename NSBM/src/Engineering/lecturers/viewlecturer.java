...
public class viewlecturer extends javax.swing.JFrame {
    ...
    ArrayList<ELecturer> ELList1;
    ELecDBOperation bldb=new ELecDBOperation();
    
    void loadLecterer(){
        ELList1=bldb.getlecturer(); //for the first year students
        ELecturerDetails bll=new ELecturerDetails(ELList1);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        lp.setVisible(true);
        lp.setFields(ELList1.get(tblyear1lec.getSelectedRow()));
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        ul.setVisible(true);
        ul.setFields(ELList1.get(tblyear1lec.getSelectedRow()));
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        dl.setVisible(true);
        dl.setFields(ELList1.get(tblyear1lec.getSelectedRow()));
