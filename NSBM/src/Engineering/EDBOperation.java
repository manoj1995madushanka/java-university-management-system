...
public class EDBOperation {
    ...
    public boolean intakeStudent(EStudent bst) {
        try {

            System.out.println("Add student 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            String query = "INSERT INTO schoolofengineering VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            pst.setString(14, bst.getMathematics());
            pst.setString(15, bst.getPhysics());
            pst.setString(16, bst.getChemistry());
    ...
    public ArrayList<EStudent> getStudent1() {
        try {

            ArrayList<EStudent> list1 = new ArrayList<EStudent>();

            System.out.println("Get student 1");
            con = (Connection) DriverManager.getConnection(url, username, password);
            
            int curyear = Calendar.getInstance().get(Calendar.YEAR);
            String query = "SELECT * FROM schoolofengineering WHERE intakeyear="+curyear;//schoolofengineering
...
//qualificationtype,institute,yearofcomplete
                ...
                s.setMathematics(rs.getString(14));
                s.setPhysics(rs.getString(15));
                s.setChemistry(rs.getString(16));
    ...
    public ArrayList<EStudent> getStudent2() {
        try {
...
//qualificationtype,institute,yearofcomplete
                ...
                s1.setMathematics(rs1.getString(14));
                s1.setPhysics(rs1.getString(15));
                s1.setChemistry(rs1.getString(16));
    ...
    public ArrayList<EStudent> getStudent3() {
        try {

            ArrayList<EStudent> list = new ArrayList<EStudent>();
...
//qualificationtype,institute,yearofcomplete
                ...
                s.setALindex(rs.getInt(12));
                s.setZscore(rs.getDouble(13));
                s.setMathematics(rs1.getString(14));
                s.setPhysics(rs1.getString(15));
                s.setChemistry(rs1.getString(16));
                s.setEnglish(rs.getString(17));
                s.setQualificationlevel(rs.getString(18));
                s.setQualificationtype(rs.getString(19));
                s.setInstitute(rs.getString(20));
    ...
    public ArrayList<EStudent> getStudent4() {
        try {
